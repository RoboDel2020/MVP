...
namespace RoboDel.Controllers
{
    public class AddOrderRestaurantController : Controller
    {
        ...
        public IActionResult AddAnOrderRestaurant(string pickupTime, bool readyForPickup, string firstName, string lastName,  string phoneNumber, string email, string address, string apartment, string city,  string zip, string state, string country)
        {
